		...
		if step.transi != null:
			...
			if player != null:
				if not step.transi.interactive:
					#player.tween_callback( set_interection_paused(true))
					player.tween_callback(set_interaction_paused.bind(true))
				...
				if not step.transi.interactive:
					#player.tween_callback(set_interection_paused(false))
					player.tween_callback(set_interaction_paused.bind(false))
